"""
Test Case: TC_OB_006
Title: Verify Back button on Step 1
Description: Verify Back button on Step 1
Priority: Medium
Type: Positive
...
def test_tc_ob_006(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_006
    Description: Verify Back button on Step 1
    Priority: Medium
    ...
    Expected Results:
    1. Back button is visible on Step 1
    2. Clicking Back may: navigate to previous page (sign up confirmation) OR be disabled/hidden on Step 1
    3. Application does not crash
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_006 - Verify Back button on Step 1")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_006_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_006_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_006_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_006")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_006_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
