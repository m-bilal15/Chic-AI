...
def test_tc_chat_ai_011(page):
    """
    TC_CHAT_AI_011: Verify AI response is formatted properly

    Description: Check AI responses have good formatting
    Expected: Response has paragraphs, lists, or structure
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_011"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_011 - Verify AI response is formatted properly")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_011_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_011_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_011_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_011_PASSED.png", full_page=True)
