"""
Test Case: TC_DASH_030
Title: Verify chat AI response time
Priority: High
Type: Performance
...
@pytest.mark.high
def test_tc_dash_030(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_030
    Description: Verify chat AI response time

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_030 - Verify chat AI response time")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash030@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_030_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_030_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_030_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_030")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_030_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
