"""
Test Case: TC_OB_S4_010
Title: Verify Continue with less than 6 colors selected
Description: Verify Continue with less than 6 colors selected
Priority: High
Type: Negative
...
def test_tc_ob_s4_010(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S4_010
    Description: Verify Continue with less than 6 colors selected
    Priority: High
    ...
    2. Select only 2 colors
    3. Click "Continue →"

    Expected Results:
    1. Either: Allowed to continue with partial selection
    2. OR: Validation prompts to select more
    3. Note: "Select 6 more colors" hint suggests 6 may be required
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S4_010 - Verify Continue with less than 6 colors selected")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S4_010_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S4_010_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S4_010_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S4_010")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S4_010_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
