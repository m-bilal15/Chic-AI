"""
Test Case: TC_DASH_009
Title: Verify "Style Chat" navigation item is active by default
Priority: High
"""
...
@pytest.mark.high
def test_tc_dash_009(page, signup_page, onboarding_page, base_url):
    print(chr(10) + "="*70)
    print("TEST: TC_DASH_009")
    print("="*70)
    
    try:
        # Signup first
        test_email = "test_tcdash009@auto.com"
        page.goto(base_url)
        ...
        page.screenshot(path="results/TC_DASH_009_PASSED.png", full_page=True)
        print(chr(10) + "[PASS] TEST PASSED: TC_DASH_009" + chr(10))
        
    except Exception as e:
        page.screenshot(path="results/TC_DASH_009_FAILED.png", full_page=True)
