...
def test_tc_chat_pers_009(page):
    """
    TC_CHAT_PERS_009: Verify AI adapts to user feedback in conversation

    Tests that AI uses onboarding data for personalized responses
    Expected: Third response reflects casual preference
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_009"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_009 - Verify AI adapts to user feedback in conversation")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_009_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_009_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_009_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_009_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_009_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_009 COMPLETE")
        print("=" * 80 + "\n")
