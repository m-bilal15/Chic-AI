"""
Test Case: TC_OB_S4_003
Title: Verify selecting a single color
Description: Verify selecting a single color
Priority: Critical
Type: Positive
...
def test_tc_ob_s4_003(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S4_003
    Description: Verify selecting a single color
    Priority: Critical
    ...
    2. Click on "Black" color circle

    Expected Results:
    1. Black is selected (visual indicator: checkmark, border, or highlight)
    2. "Selected Colors" section shows the selected color
    3. Counter updates from "0/6" to "1/6"
    4. Hint text updates to "Select 5 more colors"
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S4_003 - Verify selecting a single color")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S4_003_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S4_003_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S4_003_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S4_003")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S4_003_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
