"""
Test Case: TC_DASH_001
Title: Verify Dashboard page loads successfully after tour completi
Priority: Critical
Type: Positive
...
def test_tc_dash_001(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_001
    Description: Verify Dashboard page loads successfully after tour completi

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_001 - Verify Dashboard page loads successfully after tour completi")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash001@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_001_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_001_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_001_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_001")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_001_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
