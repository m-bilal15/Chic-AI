"""
Test Case: TC_OB_S3_003
Title: Verify Step 3 is optional (Continue without selection)
Description: Verify Step 3 is optional (Continue without selection)
Priority: Critical
Type: Positive
...
def test_tc_ob_s3_003(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S3_003
    Description: Verify Step 3 is optional (Continue without selection)
    Priority: Critical
    ...
    Expected Results:
    1. User advances to Step 4 successfully
    2. No validation error (step is optional)
    3. "Select areas you'd like to balance (optional)" hint confirms optionality
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S3_003 - Verify Step 3 is optional (Continue without selection)")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S3_003_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S3_003_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S3_003_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S3_003")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S3_003_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
