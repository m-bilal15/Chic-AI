...
def test_tc_chat_msg_006(page):
    """
    TC_CHAT_MSG_006: Send very long message (1000+ characters)

    Description: Verify character limit handling for long messages
    Priority: High
    Type: Boundary Testing

    Expected Result: Long message handled (sent, truncated, or prevented)
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_006"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_006 - Send very long message (1000+ characters)")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_006_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Send very long message (1000+ characters)")
        print("-" * 80 + "\n")
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_006_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_006_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_006_PASSED.png", full_page=True)
