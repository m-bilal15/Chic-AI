"""
Test Case: TC_DASH_035
Title: Verify chat scroll behavior with multiple messages
Priority: Medium
Type: Positive
...
@pytest.mark.medium
def test_tc_dash_035(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_035
    Description: Verify chat scroll behavior with multiple messages

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_035 - Verify chat scroll behavior with multiple messages")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash035@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_035_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_035_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_035_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_035")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_035_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
