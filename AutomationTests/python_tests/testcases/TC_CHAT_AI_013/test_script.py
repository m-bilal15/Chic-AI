...
def test_tc_chat_ai_013(page):
    """
    TC_CHAT_AI_013: Verify AI response to shopping request

    Description: Check AI handles shopping-related queries
    Expected: AI provides shopping recommendations
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_013"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_013 - Verify AI response to shopping request")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_013_chat_ready.png", full_page=True)
        ...
        # Send message to AI
        message = "I want to buy a new dress for summer"
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_013_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_013_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_013_PASSED.png", full_page=True)
