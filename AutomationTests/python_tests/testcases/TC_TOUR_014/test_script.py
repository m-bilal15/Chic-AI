"""
Test Case: TC_TOUR_014
Title: Verify tour does NOT reappear after completion
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_014(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_014
    Description: Verify tour does NOT reappear after completion

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_014 - Verify tour does NOT reappear after completion")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour014@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_014_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_014_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_014_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_014")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_014_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
