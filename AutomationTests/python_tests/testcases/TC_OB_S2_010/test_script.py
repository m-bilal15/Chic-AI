"""
Test Case: TC_OB_S2_010
Title: Verify Back button returns to Step 1 with selection intact
Description: Verify Back button returns to Step 1 with selection intact
Priority: High
Type: Positive
...
def test_tc_ob_s2_010(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S2_010
    Description: Verify Back button returns to Step 1 with selection intact
    Priority: High
    ...
    Steps:
    1. Complete Step 1 (select Hourglass)
    ...
    2. "Hourglass" is still selected on Step 1
    3. Progress indicator reverts to Step 1 active
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S2_010 - Verify Back button returns to Step 1 with selection intact")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S2_010_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S2_010_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S2_010_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S2_010")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S2_010_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
