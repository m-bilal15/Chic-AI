"""
Test Case: TC_DASH_017
Title: Verify sending empty message
Priority: High
Type: Negative
...
@pytest.mark.high
def test_tc_dash_017(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_017
    Description: Verify sending empty message

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_017 - Verify sending empty message")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash017@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_017_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_017_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_017_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_017")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_017_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
