...
def test_tc_chat_ai_008(page):
    """
    TC_CHAT_AI_008: Verify AI shows typing indicator

    Description: Check loading indicator while AI is responding
    Expected: Typing indicator or loading state visible
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_008"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_008 - Verify AI shows typing indicator")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_008_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_008_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_008_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_008_PASSED.png", full_page=True)
