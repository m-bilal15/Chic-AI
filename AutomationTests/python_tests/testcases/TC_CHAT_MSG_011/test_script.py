...
def test_tc_chat_msg_011(page):
    """
    TC_CHAT_MSG_011: Verify chat input clears after sending

    Description: Check input field is cleared after message sent
    Priority: Medium
    Type: Positive - UX

    Expected Result: Input field empty after send
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_011"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_011 - Verify chat input clears after sending")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_011_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Verify chat input clears after sending")
        print("-" * 80 + "\n")
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_011_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_011_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_011_PASSED.png", full_page=True)
