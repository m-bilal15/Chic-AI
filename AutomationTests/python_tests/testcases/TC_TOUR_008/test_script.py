"""
Test Case: TC_TOUR_008
Title: Verify Tour Step 7 - Settings & More (highlights Settings)
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_008(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_008
    Description: Verify Tour Step 7 - Settings & More (highlights Settings)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_008 - Verify Tour Step 7 - Settings & More (highlights Settings)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour008@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_008_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_008_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_008_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_008")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_008_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
