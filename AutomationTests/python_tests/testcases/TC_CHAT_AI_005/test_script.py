...
def test_tc_chat_ai_005(page):
    """
    TC_CHAT_AI_005: Verify AI provides color recommendations

    Description: Check AI suggests colors for user
    Expected: Response contains color suggestions
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_005"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_005 - Verify AI provides color recommendations")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_005_chat_ready.png", full_page=True)
        ...
        # Send message to AI
        message = "What colors would look good on me?"
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_005_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_005_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_005_PASSED.png", full_page=True)
