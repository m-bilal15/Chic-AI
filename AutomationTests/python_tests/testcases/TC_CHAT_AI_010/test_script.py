...
def test_tc_chat_ai_010(page):
    """
    TC_CHAT_AI_010: Verify AI provides product links

    Description: Check AI includes product recommendations with links
    Expected: Response contains product links or references
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_010"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_010 - Verify AI provides product links")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_010_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_010_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_010_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_010_PASSED.png", full_page=True)
