...
def test_tc_chat_msg_005(page):
    """
    TC_CHAT_MSG_005: Send message with only spaces

    Description: Verify whitespace-only messages are prevented
    Priority: High
    Type: Negative - Validation

    Expected Result: Whitespace trimmed, message prevented
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_005"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_005 - Send message with only spaces")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_005_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Send message with only spaces")
        print("-" * 80 + "\n")
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_005_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_005_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_005_PASSED.png", full_page=True)
