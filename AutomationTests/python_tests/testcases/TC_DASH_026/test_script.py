"""
Test Case: TC_DASH_026
Title: Verify Dashboard requires authentication
Priority: Critical
Type: Security
...
def test_tc_dash_026(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_026
    ...
    print("\n" + "="*70)
    print("TEST: TC_DASH_026 - Verify Dashboard requires authentication")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash026@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_026_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_026_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_026_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_026")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_026_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
