"""
Test Case: TC_TOUR_004
Title: Verify Tour Step 3 - Outfit Check (highlights Upload Outfit)
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_004(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_004
    Description: Verify Tour Step 3 - Outfit Check (highlights Upload Outfit)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_004 - Verify Tour Step 3 - Outfit Check (highlights Upload Outfit)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour004@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_004_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_004_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_004_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_004")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_004_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
