"""
Test Case: TC_TOUR_010
Title: Verify complete tour flow end-to-end (all 7 steps)
Priority: Critical
Type: Positive
...
def test_tc_tour_010(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_010
    Description: Verify complete tour flow end-to-end (all 7 steps)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_010 - Verify complete tour flow end-to-end (all 7 steps)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour010@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_010_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_010_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_010_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_010")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_010_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
