"""
Test Case: TC_DASH_002
Title: Verify Left Sidebar content and navigation items
Priority: Critical
Type: Positive
...
def test_tc_dash_002(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_002
    Description: Verify Left Sidebar content and navigation items

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_002 - Verify Left Sidebar content and navigation items")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash002@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_002_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_002_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_002_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_002")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_002_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
