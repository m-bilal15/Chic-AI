"""
Test Case: TC_OB_S4_009
Title: Verify Continue without selecting any color
Description: Verify Continue without selecting any color
Priority: High
Type: Negative
...
def test_tc_ob_s4_009(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S4_009
    Description: Verify Continue without selecting any color
    Priority: High
    ...
    2. Do NOT select any color
    3. Click "Continue →"

    Expected Results:
    1. Either: Validation error (e.g., "Please select at least 1 color")
    2. OR: Allowed to continue (if optional)
    3. Verify against business requirements
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S4_009 - Verify Continue without selecting any color")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S4_009_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S4_009_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S4_009_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S4_009")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S4_009_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
