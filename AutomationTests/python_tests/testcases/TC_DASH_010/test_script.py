"""
Test Case: TC_DASH_010
Title: Verify "Shop" navigation click
Priority: High
"""
...
@pytest.mark.high
def test_tc_dash_010(page, signup_page, onboarding_page, base_url):
    print(chr(10) + "="*70)
    print("TEST: TC_DASH_010")
    print("="*70)
    
    try:
        # Signup first
        test_email = "test_tcdash010@auto.com"
        page.goto(base_url)
        ...
        page.screenshot(path="results/TC_DASH_010_PASSED.png", full_page=True)
        print(chr(10) + "[PASS] TEST PASSED: TC_DASH_010" + chr(10))
        
    except Exception as e:
        page.screenshot(path="results/TC_DASH_010_FAILED.png", full_page=True)
