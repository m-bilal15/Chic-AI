"""
Test Case: TC_OB_005
Title: Verify "Skip for now" link skips entire questionnaire
Description: Verify "Skip for now" link skips entire questionnaire
Priority: High
Type: Positive
...
def test_tc_ob_005(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_005
    Description: Verify "Skip for now" link skips entire questionnaire
    Priority: High
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_005_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_005_evidence.png", full_page=True)

        # Final screenshot
        page.screenshot(path="results/TC_OB_005_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_005")
        print("="*70)
        print("\n[RESULT] Test completed successfully")
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_OB_005_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
