"""
Test Case: TC_OB_S4_004
Title: Verify selecting exactly 6 colors (maximum)
Description: Verify selecting exactly 6 colors (maximum)
Priority: Critical
Type: Positive
...
def test_tc_ob_s4_004(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S4_004
    Description: Verify selecting exactly 6 colors (maximum)
    Priority: Critical
    ...
    2. Click 6 colors one by one: Black, White, Navy Blue, Red, Green, Gold

    Expected Results:
    1. All 6 colors are selected
    2. Counter shows "6/6"
    3. "Selected Colors" section shows all 6 selected colors
    4. Hint text changes (e.g., "You've selected 6 colors" or disappears)
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S4_004 - Verify selecting exactly 6 colors (maximum)")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S4_004_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S4_004_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S4_004_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S4_004")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S4_004_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
