...
def test_tc_chat_msg_015(page):
    """
    TC_CHAT_MSG_015: Rapidly send 5 messages

    Description: Test rapid consecutive message sending
    Priority: Medium
    Type: Performance

    Expected Result: All messages sent, no race conditions
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_015"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_015 - Rapidly send 5 messages")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_015_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Rapidly send 5 messages")
        print("-" * 80 + "\n")
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_015_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_015_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_015_PASSED.png", full_page=True)
