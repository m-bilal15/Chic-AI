"""
Test Case: TC_TOUR_020
Title: Verify tour responsive behavior on Mobile (375x812)
Priority: Medium
Type: UI/UX
...
@pytest.mark.medium
def test_tc_tour_020(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_020
    Description: Verify tour responsive behavior on Mobile (375x812)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_020 - Verify tour responsive behavior on Mobile (375x812)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour020@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_020_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_020_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_020_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_020")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_020_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
