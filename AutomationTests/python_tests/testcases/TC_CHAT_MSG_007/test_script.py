...
def test_tc_chat_msg_007(page):
    ...
    Expected Result: Emojis display correctly
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_007"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_007 - Send message with emojis")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_007_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Send message with emojis")
        print("-" * 80 + "\n")
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_007_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_007_message_sent.png", full_page=True)
        ...
        for msg in messages:
            try:
                ...
                if message_text in msg_text:
                    message_found = True
                    print(f"[OK] Emoji message found in chat")
                    break
            except:
                pass
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_007_PASSED.png", full_page=True)
