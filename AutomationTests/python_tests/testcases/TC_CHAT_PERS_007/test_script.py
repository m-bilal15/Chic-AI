...
def test_tc_chat_pers_007(page):
    """
    TC_CHAT_PERS_007: Verify AI provides holistic recommendations

    Tests that AI uses onboarding data for personalized responses
    Expected: Response integrates body type, colors, and style preferences
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_007"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_007 - Verify AI provides holistic recommendations")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_007_chat_ready.png", full_page=True)
        ...
        message = "Give me your best styling recommendations"
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_007_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_007_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_007_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_007_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_007 COMPLETE")
        print("=" * 80 + "\n")
