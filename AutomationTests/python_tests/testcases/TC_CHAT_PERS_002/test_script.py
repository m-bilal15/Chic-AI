...
def test_tc_chat_pers_002(page):
    """
    TC_CHAT_PERS_002: Verify AI suggests user's favorite colors

    Tests that AI uses onboarding data for personalized responses
    Expected: Response suggests colors selected in onboarding
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_002"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_002 - Verify AI suggests user's favorite colors")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_002_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_002_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_002_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_002_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_002_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_002 COMPLETE")
        print("=" * 80 + "\n")
