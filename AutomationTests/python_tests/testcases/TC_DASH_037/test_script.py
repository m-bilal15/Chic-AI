"""
Test Case: TC_DASH_037
Title: Verify multiple conversations in sidebar
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_dash_037(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_037
    Description: Verify multiple conversations in sidebar

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_037 - Verify multiple conversations in sidebar")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash037@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_037_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_037_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_037_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_037")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_037_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
