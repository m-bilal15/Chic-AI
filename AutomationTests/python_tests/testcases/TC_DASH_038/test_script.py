"""
Test Case: TC_DASH_038
Title: Verify switching between conversations preserves chat histor
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_dash_038(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_038
    Description: Verify switching between conversations preserves chat histor

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_038 - Verify switching between conversations preserves chat histor")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash038@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_038_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_038_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_038_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_038")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_038_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
