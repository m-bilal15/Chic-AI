"""
Test Case: TC_TOUR_007
Title: Verify Tour Step 6 - Your Style Profile (highlights Basic Pr
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_007(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_007
    Description: Verify Tour Step 6 - Your Style Profile (highlights Basic Pr

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_007 - Verify Tour Step 6 - Your Style Profile (highlights Basic Pr")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour007@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_007_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_007_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_007_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_007")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_007_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
