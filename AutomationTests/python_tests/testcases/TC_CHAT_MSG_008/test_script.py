...
def test_tc_chat_msg_008(page):
    """
    TC_CHAT_MSG_008: Send message with special characters

    Description: Verify special characters are handled properly
    Priority: Medium
    Type: Positive - Messaging

    Expected Result: Special chars display correctly
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_008"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_008 - Send message with special characters")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_008_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Send message with special characters")
        print("-" * 80 + "\n")

        # Send test message
        message_text = "What about this & that, or this/that? It's great!"
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_008_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_008_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_008_PASSED.png", full_page=True)
