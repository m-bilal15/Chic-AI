"""
Test Case: TC_DASH_005
Title: Verify "CHIC Concierge" header shows Online status
Priority: Medium
"""
...
@pytest.mark.medium
def test_tc_dash_005(page, signup_page, onboarding_page, base_url):
    print(chr(10) + "="*70)
    print("TEST: TC_DASH_005")
    print("="*70)
    
    try:
        # Signup first
        test_email = "test_tcdash005@auto.com"
        page.goto(base_url)
        ...
        page.screenshot(path="results/TC_DASH_005_PASSED.png", full_page=True)
        print(chr(10) + "[PASS] TEST PASSED: TC_DASH_005" + chr(10))
        
    except Exception as e:
        page.screenshot(path="results/TC_DASH_005_FAILED.png", full_page=True)
