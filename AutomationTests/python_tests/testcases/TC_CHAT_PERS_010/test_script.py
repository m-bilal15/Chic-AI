...
def test_tc_chat_pers_010(page):
    """
    TC_CHAT_PERS_010: Verify profile-based product recommendations

    Tests that AI uses onboarding data for personalized responses
    Expected: Product recommendations match onboarding preferences
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_010"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_010 - Verify profile-based product recommendations")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_010_chat_ready.png", full_page=True)
        ...
        message = "Show me products that suit my style"
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_010_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_010_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_010_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_010_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_010 COMPLETE")
        print("=" * 80 + "\n")
