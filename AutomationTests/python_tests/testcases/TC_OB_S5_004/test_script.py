"""
Test Case: TC_OB_S5_004
Title: Verify selecting exactly 3 styles (maximum)
Description: Verify selecting exactly 3 styles (maximum)
Priority: Critical
Type: Positive
...
def test_tc_ob_s5_004(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_004
    Description: Verify selecting exactly 3 styles (maximum)
    Priority: Critical
    ...
    Expected Results:
    1. All 3 styles are selected
    2. Visual indicator on all 3 cards
    3. Hint updates or max selection is reached
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S5_004 - Verify selecting exactly 3 styles (maximum)")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_004_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_004_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_004_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_004")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S5_004_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
