"""
Test Case: TC_OB_S5_008
Title: Verify "Complete Setup" with 1 style selected
Description: Verify "Complete Setup" with 1 style selected
Priority: High
Type: Positive
...
def test_tc_ob_s5_008(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_008
    Description: Verify "Complete Setup" with 1 style selected
    Priority: High
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_008_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_008_evidence.png", full_page=True)

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_008_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_008")
        print("="*70)
        print("\n[RESULT] Test completed successfully")
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_OB_S5_008_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
