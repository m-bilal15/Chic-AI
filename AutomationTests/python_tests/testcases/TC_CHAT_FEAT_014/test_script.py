...
def test_tc_chat_feat_014(page):
    """
    TC_CHAT_FEAT_014: Upload oversized image

    Action: 
    Expected: Large file rejected with size limit error
    """

    # Test ID constant
    tc_id = "TC_CHAT_FEAT_014"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_FEAT_014 - Upload oversized image")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_FEAT_014_chat_ready.png", full_page=True)
