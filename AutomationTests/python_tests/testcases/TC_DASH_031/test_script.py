"""
Test Case: TC_DASH_031
Title: Verify Dashboard responsive layout on Mobile (375x812)
Priority: High
Type: UI/UX
...
@pytest.mark.high
def test_tc_dash_031(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_031
    Description: Verify Dashboard responsive layout on Mobile (375x812)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_031 - Verify Dashboard responsive layout on Mobile (375x812)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash031@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_031_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_031_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_031_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_031")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_031_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
