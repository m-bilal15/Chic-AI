"""
Test Case: TC_DASH_020
Title: Verify "Upload Outfit" button functionality
Priority: High
"""
...
@pytest.mark.high
def test_tc_dash_020(page, signup_page, onboarding_page, base_url):
    print(chr(10) + "="*70)
    print("TEST: TC_DASH_020")
    print("="*70)
    
    try:
        # Signup first
        test_email = "test_tcdash020@auto.com"
        page.goto(base_url)
        ...
        page.screenshot(path="results/TC_DASH_020_PASSED.png", full_page=True)
        print(chr(10) + "[PASS] TEST PASSED: TC_DASH_020" + chr(10))
        
    except Exception as e:
        page.screenshot(path="results/TC_DASH_020_FAILED.png", full_page=True)
