"""
Test Case: TC_DASH_027
Title: Verify XSS prevention in chat input
Priority: Critical
Type: Security
...
def test_tc_dash_027(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_027
    Description: Verify XSS prevention in chat input

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_027 - Verify XSS prevention in chat input")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash027@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_027_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_027_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_027_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_027")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_027_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
