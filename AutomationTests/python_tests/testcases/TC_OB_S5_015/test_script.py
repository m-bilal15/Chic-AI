"""
Test Case: TC_OB_S5_015
Title: Verify Back button returns to Step 4 with selections intact
Description: Verify Back button returns to Step 4 with selections intact
Priority: High
Type: Positive
...
def test_tc_ob_s5_015(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_015
    Description: Verify Back button returns to Step 4 with selections intact
    Priority: High
    ...
    Steps:
    1. Complete Steps 1-4 with selections
    2. On Step 5, click "< Back"

    Expected Results:
    1. User returns to Step 4
    2. Step 4 color selections are preserved
    3. Progress indicator updates
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S5_015 - Verify Back button returns to Step 4 with selections intact")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_015_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_015_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_015_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_015")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S5_015_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
