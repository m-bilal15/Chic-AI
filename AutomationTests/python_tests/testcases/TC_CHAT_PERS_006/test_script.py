...
def test_tc_chat_pers_006(page):
    """
    TC_CHAT_PERS_006: Verify AI initial greeting is personalized

    Tests that AI uses onboarding data for personalized responses
    Expected: Greeting uses user's name from signup
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_006"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_006 - Verify AI initial greeting is personalized")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_006_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_006_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_006_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_006_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_006_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_006 COMPLETE")
        print("=" * 80 + "\n")
