"""
Test Case: TC_OB_S3_010
Title: Verify card illustrations load properly for all 7 options
Description: Verify card illustrations load properly for all 7 options
Priority: Medium
Type: UI/UX
...
@pytest.mark.medium
@pytest.mark.ui_ux
def test_tc_ob_s3_010(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S3_010
    Description: Verify card illustrations load properly for all 7 options
    Priority: Medium
    ...
    Expected Results:
    1. All 7 illustrations load correctly
    2. No broken/missing images
    3. Each illustration represents the corresponding body area
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S3_010 - Verify card illustrations load properly for all 7 options")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S3_010_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S3_010_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S3_010_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S3_010")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S3_010_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
