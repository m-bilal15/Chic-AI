...
def test_tc_chat_ai_007(page):
    """
    TC_CHAT_AI_007: Verify AI handles unclear questions
    ...
    # Test ID constant
    tc_id = "TC_CHAT_AI_007"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_007 - Verify AI handles unclear questions")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_007_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_007_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_007_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_007_PASSED.png", full_page=True)
