"""
Test Case: TC_OB_S5_009
Title: Verify "Complete Setup" with 2 styles selected
Description: Verify "Complete Setup" with 2 styles selected
Priority: High
Type: Positive
...
def test_tc_ob_s5_009(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_009
    Description: Verify "Complete Setup" with 2 styles selected
    Priority: High
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_009_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_009_evidence.png", full_page=True)

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_009_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_009")
        print("="*70)
        print("\n[RESULT] Test completed successfully")
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_OB_S5_009_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
