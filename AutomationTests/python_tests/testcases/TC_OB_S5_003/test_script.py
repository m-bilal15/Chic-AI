"""
Test Case: TC_OB_S5_003
Title: Verify selecting a single style
Description: Verify selecting a single style
Priority: High
Type: Positive
...
def test_tc_ob_s5_003(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_003
    Description: Verify selecting a single style
    Priority: High
    ...
    Expected Results:
    1. Chic card is selected (visual indicator)
    2. Other cards remain unselected
    3. Selection is highlighted
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S5_003 - Verify selecting a single style")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_003_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_003_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_003_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_003")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S5_003_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
