"""
Test Case: TC_OB_S4_006
Title: Verify deselecting a color
Description: Verify deselecting a color
Priority: High
Type: Positive
...
def test_tc_ob_s4_006(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S4_006
    Description: Verify deselecting a color
    Priority: High
    ...
    Expected Results:
    1. Red is deselected (removed from selection)
    2. Counter decrements (e.g., "1/6" to "0/6")
    3. Red is removed from "Selected Colors" section
    4. User can now select a different color
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S4_006 - Verify deselecting a color")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S4_006_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S4_006_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S4_006_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S4_006")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S4_006_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
