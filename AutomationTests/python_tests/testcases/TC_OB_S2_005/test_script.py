"""
Test Case: TC_OB_S2_005
Title: Verify deselecting an option (toggle)
Description: Verify deselecting an option (toggle)
Priority: High
Type: Positive
...
def test_tc_ob_s2_005(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S2_005
    Description: Verify deselecting an option (toggle)
    Priority: High
    ...
    2. Click "Shoulders" to select
    3. Click "Shoulders" again to deselect

    Expected Results:
    1. First click: Shoulders is selected
    2. Second click: Shoulders is deselected
    3. Toggle behavior works correctly
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S2_005 - Verify deselecting an option (toggle)")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S2_005_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S2_005_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S2_005_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S2_005")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S2_005_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
