"""
Test Case: TC_TOUR_012
Title: Verify "Back" button navigates to previous tour step
Priority: High
"""
...
@pytest.mark.high
def test_tc_tour_012(page, signup_page, onboarding_page, base_url):
    print(chr(10) + "="*70)
    print("TEST: TC_TOUR_012")
    print("="*70)
    
    try:
        # Signup first
        test_email = "test_tctour012@auto.com"
        page.goto(base_url)
        ...
        page.screenshot(path="results/TC_TOUR_012_PASSED.png", full_page=True)
        print(chr(10) + "[PASS] TEST PASSED: TC_TOUR_012" + chr(10))
        
    except Exception as e:
        page.screenshot(path="results/TC_TOUR_012_FAILED.png", full_page=True)
