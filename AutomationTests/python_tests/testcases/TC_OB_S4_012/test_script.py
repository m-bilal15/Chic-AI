"""
Test Case: TC_OB_S4_012
Title: Verify swap color selection when at max limit
Description: Verify swap color selection when at max limit
Priority: Medium
Type: Positive
...
def test_tc_ob_s4_012(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S4_012
    Description: Verify swap color selection when at max limit
    Priority: Medium
    ...
    Steps:
    1. Select 6 colors
    2. Deselect one color
    3. Select a different color

    Expected Results:
    1. After deselecting: counter shows "5/6"
    2. Can select a new color to replace
    3. Counter returns to "6/6"
    4. Swap is smooth without errors
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S4_012 - Verify swap color selection when at max limit")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S4_012_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S4_012_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S4_012_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S4_012")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S4_012_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
