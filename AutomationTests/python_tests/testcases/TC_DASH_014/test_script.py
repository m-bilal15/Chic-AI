"""
Test Case: TC_DASH_014
Title: Verify sending a message in chat
Priority: Critical
Type: Positive
...
def test_tc_dash_014(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_014
    Description: Verify sending a message in chat

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_014 - Verify sending a message in chat")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash014@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_014_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_014_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_014_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_014")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_014_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
