"""
Test Case: TC_DASH_016
Title: Verify 500 character limit on chat input
Priority: High
Type: Negative
...
@pytest.mark.high
def test_tc_dash_016(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_016
    Description: Verify 500 character limit on chat input

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_016 - Verify 500 character limit on chat input")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash016@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_016_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_016_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_016_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_016")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_016_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
