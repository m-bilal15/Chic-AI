...
def test_tc_chat_feat_006(page):
    """
    TC_CHAT_FEAT_006: Access Settings from sidebar
    ...
    # Test ID constant
    tc_id = "TC_CHAT_FEAT_006"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_FEAT_006 - Access Settings from sidebar")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_FEAT_006_chat_ready.png", full_page=True)
        print("[PRECONDITION] Chat page ready\n")

        # TEST: Feature functionality
        print(f"[TEST] Testing: Click 'Settings'")
        print("-" * 80 + "\n")

        # Navigate to Settings
        print(f"[STEP] Clicking '{menu_item}' in sidebar...")

        menu_link = page.locator('a:has-text("Settings"), button:has-text("Settings")')
        assert menu_link.count() > 0, "Settings menu not found"
        ...
        print("\n[PASS] Navigation to Settings successful")
