"""
Test Case: TC_OB_S5_013
Title: Verify swap style selection at max limit
Description: Verify swap style selection at max limit
Priority: Medium
Type: Positive
...
def test_tc_ob_s5_013(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_013
    Description: Verify swap style selection at max limit
    Priority: Medium
    ...
    Steps:
    1. Select 3 styles
    2. Deselect one style
    3. Select a different style

    Expected Results:
    1. Deselection works, count goes to 2
    2. New selection is accepted, count returns to 3
    3. Swap is smooth
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S5_013 - Verify swap style selection at max limit")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_013_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_013_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_013_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_013")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S5_013_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
