"""
Test Case: TC_OB_S1_009
Title: Verify card hover effect on body type options
Description: Verify card hover effect on body type options
Priority: Low
Type: UI/UX
...
@pytest.mark.low
@pytest.mark.ui_ux
def test_tc_ob_s1_009(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S1_009
    Description: Verify card hover effect on body type options
    Priority: Low
    ...
    2. Hover mouse over each body type card

    Expected Results:
    1. Card shows hover effect (shadow, border color change, or slight scale)
    2. Cursor changes to pointer
    3. Visual feedback indicates the card is clickable
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S1_009 - Verify card hover effect on body type options")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S1_009_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S1_009_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S1_009_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S1_009")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S1_009_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
