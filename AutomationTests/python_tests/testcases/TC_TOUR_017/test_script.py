"""
Test Case: TC_TOUR_017
Title: Verify tour progress bar visual accuracy
Priority: Low
Type: UI/UX
...
@pytest.mark.low
def test_tc_tour_017(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_017
    Description: Verify tour progress bar visual accuracy

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_017 - Verify tour progress bar visual accuracy")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour017@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_017_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_017_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_017_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_017")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_017_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
