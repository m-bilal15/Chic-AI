"""
Test Case: TC_DASH_032
Title: Verify Dashboard responsive layout on Tablet (768x1024)
Priority: Medium
Type: UI/UX
...
@pytest.mark.medium
def test_tc_dash_032(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_032
    Description: Verify Dashboard responsive layout on Tablet (768x1024)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_032 - Verify Dashboard responsive layout on Tablet (768x1024)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash032@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_032_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_032_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_032_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_032")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_032_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
