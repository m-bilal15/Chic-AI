"""
Test Case: TC_OB_011
Title: Verify questionnaire requires authentication
Description: Verify questionnaire requires authentication
Priority: Critical
Type: Security
...
def test_tc_ob_011(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_011
    Description: Verify questionnaire requires authentication
    Priority: Critical
    ...
    Steps:
    1. Open a new browser (no session)
    2. Navigate directly to https://app.digitalstylist.com/questionnaire

    Expected Results:
    1. User is redirected to Login page
    2. Questionnaire is NOT accessible without authentication
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_011 - Verify questionnaire requires authentication")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_011_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_011_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_011_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_011")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_011_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
