"""
Test Case: TC_OB_S5_012
Title: Verify button label is "Complete Setup →" (not "Continue")
Description: Verify button label is "Complete Setup →" (not "Continue")
Priority: Medium
Type: UI/UX
...
@pytest.mark.medium
@pytest.mark.ui_ux
def test_tc_ob_s5_012(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_012
    Description: Verify button label is "Complete Setup →" (not "Continue")
    Priority: Medium
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_012_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_012_evidence.png", full_page=True)

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_012_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_012")
        print("="*70)
        print("\n[RESULT] Test completed successfully")
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_OB_S5_012_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
