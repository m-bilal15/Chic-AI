"""
Test Case: TC_TOUR_005
Title: Verify Tour Step 4 - Your Digital Closet (highlights My Ward
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_005(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_005
    Description: Verify Tour Step 4 - Your Digital Closet (highlights My Ward

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_005 - Verify Tour Step 4 - Your Digital Closet (highlights My Ward")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour005@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_005_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_005_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_005_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_005")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_005_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
