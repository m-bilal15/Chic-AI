"""
Test Case: TC_DASH_025
Title: Verify product recommendations are personalized
Priority: Medium
Type: Positive
...
@pytest.mark.medium
def test_tc_dash_025(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_025
    Description: Verify product recommendations are personalized

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_025 - Verify product recommendations are personalized")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash025@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_025_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_025_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_025_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_025")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_025_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
