...
def test_tc_chat_pers_003(page):
    """
    TC_CHAT_PERS_003: Verify AI respects areas to highlight

    Tests that AI uses onboarding data for personalized responses
    Expected: Response mentions highlight areas from onboarding
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_003"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_003 - Verify AI respects areas to highlight")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_003_chat_ready.png", full_page=True)
        ...
        message = "How can I accentuate my best features?"
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_003_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_003_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_003_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_003_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_003 COMPLETE")
        print("=" * 80 + "\n")
