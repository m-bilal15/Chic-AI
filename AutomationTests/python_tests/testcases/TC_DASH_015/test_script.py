"""
Test Case: TC_DASH_015
Title: Verify sending a message using Enter key
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_dash_015(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_015
    Description: Verify sending a message using Enter key

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_015 - Verify sending a message using Enter key")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash015@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_015_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_015_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_015_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_015")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_015_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
