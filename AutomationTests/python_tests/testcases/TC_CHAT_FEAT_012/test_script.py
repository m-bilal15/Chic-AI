...
def test_tc_chat_feat_012(page):
    """
    TC_CHAT_FEAT_012: Upload valid image file (PNG)

    Action: 
    Expected: PNG file uploaded successfully
    """

    # Test ID constant
    tc_id = "TC_CHAT_FEAT_012"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_FEAT_012 - Upload valid image file (PNG)")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_FEAT_012_chat_ready.png", full_page=True)
