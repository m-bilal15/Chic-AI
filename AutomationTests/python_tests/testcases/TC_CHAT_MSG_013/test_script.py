...
def test_tc_chat_msg_013(page):
    """
    TC_CHAT_MSG_013: Send message with URL

    Description: Verify URLs in messages are handled safely
    Priority: Medium
    Type: Positive - Security

    Expected Result: URL displayed safely, no XSS
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_013"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_013 - Send message with URL")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_013_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Send message with URL")
        print("-" * 80 + "\n")

        # Send test message
        message_text = "Check this out: https://example.com/outfit"
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_013_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_013_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_013_PASSED.png", full_page=True)
