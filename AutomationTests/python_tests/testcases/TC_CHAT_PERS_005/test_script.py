...
def test_tc_chat_pers_005(page):
    """
    TC_CHAT_PERS_005: Verify AI matches style descriptions

    Tests that AI uses onboarding data for personalized responses
    Expected: Suggestions match style descriptions from onboarding
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_005"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_005 - Verify AI matches style descriptions")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_005_chat_ready.png", full_page=True)
        ...
        message = "Recommend outfits that match my style"
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_005_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_005_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_005_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_005_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_005 COMPLETE")
        print("=" * 80 + "\n")
