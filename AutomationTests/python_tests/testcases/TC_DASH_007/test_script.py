"""
Test Case: TC_DASH_007
Title: Verify "+ New Conversation" button functionality
Priority: High
"""
...
@pytest.mark.high
def test_tc_dash_007(page, signup_page, onboarding_page, base_url):
    print(chr(10) + "="*70)
    print("TEST: TC_DASH_007")
    print("="*70)
    
    try:
        # Signup first
        test_email = "test_tcdash007@auto.com"
        page.goto(base_url)
        ...
        page.screenshot(path="results/TC_DASH_007_PASSED.png", full_page=True)
        print(chr(10) + "[PASS] TEST PASSED: TC_DASH_007" + chr(10))
        
    except Exception as e:
        page.screenshot(path="results/TC_DASH_007_FAILED.png", full_page=True)
