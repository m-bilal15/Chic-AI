"""
Test Case: TC_OB_S1_005
Title: Verify Continue button with a body type selected
Description: Verify Continue button with a body type selected
Priority: Critical
Type: Positive
...
def test_tc_ob_s1_005(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S1_005
    Description: Verify Continue button with a body type selected
    Priority: Critical
    ...
    2. Select any body type (e.g., "O-Shape")
    3. Click "Continue →" button

    Expected Results:
    1. User advances to Step 2 (Question 2 of 5)
    2. Progress indicator updates: Step 1 shows checkmark, Step 2 is active
    3. Selected body type is saved
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S1_005 - Verify Continue button with a body type selected")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S1_005_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S1_005_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S1_005_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S1_005")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S1_005_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
