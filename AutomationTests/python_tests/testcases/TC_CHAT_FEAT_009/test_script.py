...
def test_tc_chat_feat_009(page):
    """
    TC_CHAT_FEAT_009: Verify message persistence across page refresh

    Action: Send message, refresh page
    Expected: Message still visible after refresh
    """

    # Test ID constant
    tc_id = "TC_CHAT_FEAT_009"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_FEAT_009 - Verify message persistence across page refresh")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_FEAT_009_chat_ready.png", full_page=True)
        print("[PRECONDITION] Chat page ready\n")

        # TEST: Feature functionality
        print(f"[TEST] Testing: Send message, refresh page")
        print("-" * 80 + "\n")

        # Test feature: Send message, refresh page
        print("[STEP] Testing feature...")

        page.screenshot(path=f"results/TC_CHAT_FEAT_009_test.png", full_page=True)

        # Validation
        print("[VALIDATION] Feature check...")

        page.screenshot(path=f"results/TC_CHAT_FEAT_009_PASSED.png", full_page=True)
