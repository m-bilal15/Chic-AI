"""
Test Case: TC_TOUR_001
Title: Verify Welcome Tour modal appears on first login after onboa
Priority: Critical
Type: Positive
...
def test_tc_tour_001(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_001
    Description: Verify Welcome Tour modal appears on first login after onboa

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_001 - Verify Welcome Tour modal appears on first login after onboa")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour001@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_001_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_001_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_001_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_001")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_001_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
