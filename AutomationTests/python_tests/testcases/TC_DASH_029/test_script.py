"""
Test Case: TC_DASH_029
Title: Verify Dashboard page load time
Priority: High
Type: Performance
...
@pytest.mark.high
def test_tc_dash_029(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_029
    Description: Verify Dashboard page load time

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_029 - Verify Dashboard page load time")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash029@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_029_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_029_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_029_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_029")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_029_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
