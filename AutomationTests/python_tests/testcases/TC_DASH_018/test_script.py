"""
Test Case: TC_DASH_018
Title: Verify sending message with only spaces
Priority: Medium
Type: Negative
...
@pytest.mark.medium
def test_tc_dash_018(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_018
    Description: Verify sending message with only spaces

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_018 - Verify sending message with only spaces")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash018@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_018_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_018_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_018_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_018")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_018_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
