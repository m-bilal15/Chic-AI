"""
Test Case: TC_OB_S2_006
Title: Verify Continue without selecting any area
Description: Verify Continue without selecting any area
Priority: High
Type: Negative
...
def test_tc_ob_s2_006(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S2_006
    Description: Verify Continue without selecting any area
    Priority: High
    ...
    2. Do NOT select any area
    3. Click "Continue →"

    Expected Results:
    1. Either: Validation message shown (e.g., "Please select at least one area")
    2. OR: Allowed to continue without selection (if optional)
    3. Behavior matches business requirement
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S2_006 - Verify Continue without selecting any area")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S2_006_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S2_006_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S2_006_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S2_006")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S2_006_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
