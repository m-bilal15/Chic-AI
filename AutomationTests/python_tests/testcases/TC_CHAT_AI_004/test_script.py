...
def test_tc_chat_ai_004(page):
    """
    TC_CHAT_AI_004: Verify AI response time is under 10 seconds

    Description: Check AI responds promptly
    Expected: Response received within 10 seconds
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_004"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_004 - Verify AI response time is under 10 seconds")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_004_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_004_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_004_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_004_PASSED.png", full_page=True)
