"""
Test Case: TC_TOUR_019
Title: Verify keyboard Escape key behavior on tour modal
Priority: Low
Type: Positive
...
@pytest.mark.low
def test_tc_tour_019(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_019
    Description: Verify keyboard Escape key behavior on tour modal

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_019 - Verify keyboard Escape key behavior on tour modal")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour019@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_019_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_019_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_019_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_019")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_019_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
