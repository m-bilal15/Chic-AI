...
def test_tc_chat_ai_001(page):
    """
    TC_CHAT_AI_001: Verify AI responds to greeting

    Description: Check AI sends response to hello message
    Expected: AI responds within 10 seconds with greeting
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_001"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_001 - Verify AI responds to greeting")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_001_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_001_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_001_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_001_PASSED.png", full_page=True)
