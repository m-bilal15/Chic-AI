"""
Test Case: TC_OB_S2_004
Title: Verify selecting all 6 options
Description: Verify selecting all 6 options
Priority: High
Type: Positive
...
def test_tc_ob_s2_004(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S2_004
    Description: Verify selecting all 6 options
    Priority: High
    ...
    2. Click all 6 option cards one by one

    Expected Results:
    1. All 6 options can be selected
    2. All show selected state
    3. No limit restriction (unlike colors/styles steps)
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S2_004 - Verify selecting all 6 options")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S2_004_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S2_004_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S2_004_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S2_004")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S2_004_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
