"""
Test Case: TC_DASH_024
Title: Verify right panel is scrollable with multiple products
Priority: Medium
Type: Positive
...
@pytest.mark.medium
def test_tc_dash_024(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_024
    Description: Verify right panel is scrollable with multiple products

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_024 - Verify right panel is scrollable with multiple products")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash024@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_024_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_024_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_024_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_024")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_024_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
