...
def test_tc_chat_ai_014(page):
    """
    TC_CHAT_AI_014: Verify AI error handling when API fails
    ...
    # Test ID constant
    tc_id = "TC_CHAT_AI_014"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_014 - Verify AI error handling when API fails")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_014_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_014_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_014_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_014_PASSED.png", full_page=True)
