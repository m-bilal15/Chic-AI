...
def test_tc_chat_feat_013(page):
    """
    TC_CHAT_FEAT_013: Upload invalid file (PDF)
    ...
    # Test ID constant
    tc_id = "TC_CHAT_FEAT_013"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_FEAT_013 - Upload invalid file (PDF)")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_FEAT_013_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_FEAT_013_test.png", full_page=True)

        # Validation
        print("[VALIDATION] Feature check...")

        page.screenshot(path=f"results/TC_CHAT_FEAT_013_PASSED.png", full_page=True)
