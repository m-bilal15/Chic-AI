"""
Test Case: TC_OB_S3_004
Title: Verify multi-select functionality on minimize areas
Description: Verify multi-select functionality on minimize areas
Priority: High
Type: Positive
...
def test_tc_ob_s3_004(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S3_004
    Description: Verify multi-select functionality on minimize areas
    Priority: High
    ...
    Expected Results:
    1. All three cards are selected simultaneously
    2. Multiple selections are allowed
    3. Each shows visual selection state
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S3_004 - Verify multi-select functionality on minimize areas")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S3_004_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S3_004_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S3_004_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S3_004")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S3_004_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
