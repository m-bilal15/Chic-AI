"""
Test Case: TC_TOUR_015
Title: Verify tour highlights correct UI element at each step
Priority: High
Type: UI/UX
...
@pytest.mark.high
def test_tc_tour_015(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_015
    Description: Verify tour highlights correct UI element at each step

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_015 - Verify tour highlights correct UI element at each step")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour015@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_015_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_015_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_015_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_015")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_015_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
