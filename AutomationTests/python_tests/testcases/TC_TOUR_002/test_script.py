"""
Test Case: TC_TOUR_002
Title: Verify Tour Step 1 - Welcome to CHIC Concierge
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_002(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_002
    Description: Verify Tour Step 1 - Welcome to CHIC Concierge

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_002 - Verify Tour Step 1 - Welcome to CHIC Concierge")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour002@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_002_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_002_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_002_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_002")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_002_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
