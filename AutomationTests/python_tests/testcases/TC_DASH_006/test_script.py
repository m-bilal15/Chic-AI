"""
Test Case: TC_DASH_006
Title: Verify personalized welcome message uses correct username
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_dash_006(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_006
    Description: Verify personalized welcome message uses correct username

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_006 - Verify personalized welcome message uses correct username")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash006@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_006_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_006_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_006_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_006")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_006_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
