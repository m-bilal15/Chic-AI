...
def test_tc_chat_ai_002(page):
    """
    TC_CHAT_AI_002: Verify AI responds to style question

    Description: Check AI provides style advice
    Expected: AI responds with outfit recommendations
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_002"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_002 - Verify AI responds to style question")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_002_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_002_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_002_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_002_PASSED.png", full_page=True)
