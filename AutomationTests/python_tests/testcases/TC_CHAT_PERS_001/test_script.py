...
def test_tc_chat_pers_001(page):
    """
    TC_CHAT_PERS_001: Verify AI uses body type from onboarding

    Tests that AI uses onboarding data for personalized responses
    Expected: Response mentions body type selected in onboarding
    """

    # Test ID constant
    tc_id = "TC_CHAT_PERS_001"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_PERS_001 - Verify AI uses body type from onboarding")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_001_chat_ready.png", full_page=True)
        ...
        message = "What styles suit my body type?"
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_001_ai_personalized_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_PERS_001_PASSED.png", full_page=True)
        print("\n[PASS] Personalized response received")

    except AssertionError as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_001_FAILED.png", full_page=True)
        print(f"\n[FAIL] {e}")
        raise

    except Exception as e:
        page.screenshot(path=f"results/TC_CHAT_PERS_001_ERROR.png", full_page=True)
        print(f"\n[ERROR] {e}")
        raise

    finally:
        print("\n" + "=" * 80)
        print(f"TEST TC_CHAT_PERS_001 COMPLETE")
        print("=" * 80 + "\n")
