"""
Test Case: TC_TOUR_013
Title: Verify X (close) button on tour modal
Priority: Medium
Type: Positive
...
@pytest.mark.medium
def test_tc_tour_013(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_013
    Description: Verify X (close) button on tour modal

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_013 - Verify X (close) button on tour modal")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour013@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_013_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_013_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_013_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_013")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_013_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
