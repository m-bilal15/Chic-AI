...
def test_tc_chat_ai_003(page):
    """
    TC_CHAT_AI_003: Verify AI response appears on left side

    Description: Check AI messages are visually distinguished from user messages
    Expected: AI message has different styling/alignment than user message
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_003"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_003 - Verify AI response appears on left side")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_003_chat_ready.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_003_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_003_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_003_PASSED.png", full_page=True)
