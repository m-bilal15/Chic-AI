"""
Test Case: TC_OB_S1_003
Title: Verify selecting a body type option
Description: Verify selecting a body type option
Priority: Critical
Type: Positive
...
def test_tc_ob_s1_003(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S1_003
    Description: Verify selecting a body type option
    Priority: Critical
    ...
    2. Click on "Hourglass" card

    Expected Results:
    1. Hourglass card gets selected (highlighted/bordered)
    2. Visual feedback shows selection (e.g., colored border, checkmark, background change)
    3. Other options remain unselected
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S1_003 - Verify selecting a body type option")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S1_003_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S1_003_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S1_003_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S1_003")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S1_003_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
