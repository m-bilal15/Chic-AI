"""
Test Case: TC_TOUR_006
Title: Verify Tour Step 5 - Shop Curated Pieces (highlights Shop)
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_006(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_006
    Description: Verify Tour Step 5 - Shop Curated Pieces (highlights Shop)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_006 - Verify Tour Step 5 - Shop Curated Pieces (highlights Shop)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour006@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_006_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_006_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_006_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_006")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_006_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
