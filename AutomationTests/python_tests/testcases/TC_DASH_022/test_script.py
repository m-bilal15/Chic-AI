"""
Test Case: TC_DASH_022
Title: Verify product card displays all required information
Priority: High
Type: UI/UX
...
@pytest.mark.high
def test_tc_dash_022(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_022
    Description: Verify product card displays all required information

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_022 - Verify product card displays all required information")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash022@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_022_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_022_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_022_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_022")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_022_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
