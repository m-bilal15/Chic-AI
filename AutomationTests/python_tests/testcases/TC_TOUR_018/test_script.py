"""
Test Case: TC_TOUR_018
Title: Verify clicking outside tour modal does NOT close it
Priority: Medium
Type: Negative
...
@pytest.mark.medium
def test_tc_tour_018(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_018
    Description: Verify clicking outside tour modal does NOT close it

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_018 - Verify clicking outside tour modal does NOT close it")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour018@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_018_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_018_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_018_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_018")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_018_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
