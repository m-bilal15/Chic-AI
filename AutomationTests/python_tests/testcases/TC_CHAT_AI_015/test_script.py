...
def test_tc_chat_ai_015(page):
    """
    TC_CHAT_AI_015: Verify AI response timeout handling

    Description: Check timeout if AI takes too long
    Expected: Timeout handled gracefully after 30 seconds
    """

    # Test ID constant
    tc_id = "TC_CHAT_AI_015"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_AI_015 - Verify AI response timeout handling")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_015_chat_ready.png", full_page=True)
        ...
        # Send message to AI
        message = "Complex styling question"
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_015_message_sent.png", full_page=True)
        ...
        # Capture AI response
        page.screenshot(path=f"results/TC_CHAT_AI_015_ai_response.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_AI_015_PASSED.png", full_page=True)
