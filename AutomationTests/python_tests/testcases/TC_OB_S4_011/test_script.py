"""
Test Case: TC_OB_S4_011
Title: Verify Continue with exactly 6 colors advances to Step 5
Description: Verify Continue with exactly 6 colors advances to Step 5
Priority: Critical
Type: Positive
...
def test_tc_ob_s4_011(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S4_011
    Description: Verify Continue with exactly 6 colors advances to Step 5
    Priority: Critical
    ...
    Expected Results:
    1. User advances to Step 5
    2. Progress: Steps 1-4 checkmarks, Step 5 active
    3. Color selections are saved
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S4_011 - Verify Continue with exactly 6 colors advances to Step 5")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S4_011_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S4_011_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S4_011_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S4_011")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S4_011_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
