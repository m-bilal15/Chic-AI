"""
Test Case: TC_DASH_036
Title: Verify chat message with special characters and emojis
Priority: Medium
Type: Positive
...
@pytest.mark.medium
def test_tc_dash_036(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_DASH_036
    Description: Verify chat message with special characters and emojis

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_DASH_036 - Verify chat message with special characters and emojis")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tcdash036@automation.com"
        ...
        page.screenshot(path="results/TC_DASH_036_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_036_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_DASH_036_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_DASH_036")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_DASH_036_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
