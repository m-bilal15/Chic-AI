...
def test_tc_ob_s3_006(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S3_006
    Description: Verify deselecting an option (toggle)
    Priority: Medium
    ...
    2. Click "Midsection" to select
    3. Click "Midsection" again to deselect

    Expected Results:
    1. Toggle works correctly
    2. First click selects, second click deselects
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S3_006 - Verify deselecting an option (toggle)")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S3_006_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S3_006_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S3_006_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S3_006")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S3_006_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
