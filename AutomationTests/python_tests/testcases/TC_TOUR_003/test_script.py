"""
Test Case: TC_TOUR_003
Title: Verify Tour Step 2 - Style Chat (highlights sidebar)
Priority: High
Type: Positive
...
@pytest.mark.high
def test_tc_tour_003(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_003
    Description: Verify Tour Step 2 - Style Chat (highlights sidebar)

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_003 - Verify Tour Step 2 - Style Chat (highlights sidebar)")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour003@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_003_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_003_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_003_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_003")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_003_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
