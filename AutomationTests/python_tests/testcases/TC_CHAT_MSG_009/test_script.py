...
def test_tc_chat_msg_009(page):
    """
    TC_CHAT_MSG_009: Send message with numbers

    Description: Verify numeric content in messages
    Priority: Low
    Type: Positive - Messaging

    Expected Result: Numbers handled normally
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_009"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_009 - Send message with numbers")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_009_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Send message with numbers")
        print("-" * 80 + "\n")

        # Send test message
        message_text = "I need 5 outfits for a 3-day trip"
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_009_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_009_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_009_PASSED.png", full_page=True)
