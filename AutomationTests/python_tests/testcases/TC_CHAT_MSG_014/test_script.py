...
def test_tc_chat_msg_014(page):
    """
    TC_CHAT_MSG_014: Send message with line breaks

    Description: Verify multi-line messages are handled
    Priority: Low
    Type: Positive - Messaging

    Expected Result: Line breaks preserved or handled
    """

    # Test ID constant
    tc_id = "TC_CHAT_MSG_014"

    print("\n" + "=" * 80)
    print(f"TEST: TC_CHAT_MSG_014 - Send message with line breaks")
    print("=" * 80 + "\n")
    ...
    try:
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_014_chat_ready.png", full_page=True)
        ...
        print(f"[TEST] Testing: Send message with line breaks")
        print("-" * 80 + "\n")
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_014_message_typed.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_014_message_sent.png", full_page=True)
        ...
        page.screenshot(path=f"results/TC_CHAT_MSG_014_PASSED.png", full_page=True)
