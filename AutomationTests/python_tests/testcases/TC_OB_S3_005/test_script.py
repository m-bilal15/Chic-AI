"""
Test Case: TC_OB_S3_005
Title: Verify selecting all 7 options
Description: Verify selecting all 7 options
Priority: Medium
Type: Positive
...
def test_tc_ob_s3_005(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S3_005
    Description: Verify selecting all 7 options
    Priority: Medium
    ...
    2. Click all 7 option cards

    Expected Results:
    1. All 7 options can be selected
    2. No maximum limit enforced
    """

    print("\n" + "="*70)
    print("TEST: TC_OB_S3_005 - Verify selecting all 7 options")
    print("="*70)
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S3_005_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S3_005_evidence.png", full_page=True)
        

        # Final screenshot
        page.screenshot(path="results/TC_OB_S3_005_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S3_005")
        print("="*70)
        ...
        page.screenshot(path="results/TC_OB_S3_005_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
