"""
Test Case: TC_OB_S5_011
Title: Verify "* Required question" indicator is visible
Description: Verify "* Required question" indicator is visible
Priority: Medium
Type: UI/UX
...
@pytest.mark.medium
@pytest.mark.ui_ux
def test_tc_ob_s5_011(page, onboarding_page, base_url):
    """
    Test Case: TC_OB_S5_011
    Description: Verify "* Required question" indicator is visible
    Priority: Medium
    ...
    try:
        ...
        page.screenshot(path="results/TC_OB_S5_011_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_OB_S5_011_evidence.png", full_page=True)

        # Final screenshot
        page.screenshot(path="results/TC_OB_S5_011_final.png", full_page=True)
        print("\n[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_OB_S5_011")
        print("="*70)
        print("\n[RESULT] Test completed successfully")
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_OB_S5_011_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
