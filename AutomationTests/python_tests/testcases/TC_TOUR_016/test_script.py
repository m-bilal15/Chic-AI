"""
Test Case: TC_TOUR_016
Title: Verify tour modal is positioned correctly near highlighted e
Priority: Medium
Type: UI/UX
...
@pytest.mark.medium
def test_tc_tour_016(page, signup_page, onboarding_page, base_url):
    """
    Test Case: TC_TOUR_016
    Description: Verify tour modal is positioned correctly near highlighted e

    PRECONDITION: User must signup first (automated in this test)
    """

    print("\n" + "="*70)
    print("TEST: TC_TOUR_016 - Verify tour modal is positioned correctly near highlighted e")
    print("="*70)
    ...
    try:
        ...
        test_email = "test_tctour016@automation.com"
        ...
        page.screenshot(path="results/TC_TOUR_016_after_auth.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_016_initial.png", full_page=True)
        ...
        page.screenshot(path="results/TC_TOUR_016_PASSED.png", full_page=True)
        print("[SCREENSHOT] Final screenshot saved")

        print("\n" + "="*70)
        print("[PASS] TEST PASSED: TC_TOUR_016")
        print("="*70)
        print("\n")

    except Exception as e:
        page.screenshot(path="results/TC_TOUR_016_FAILED.png", full_page=True)
        print(f"\n[FAIL] TEST FAILED: {e}")
        print("\n")
        raise
